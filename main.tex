...
\vspace{0.7 cm}
\mbox{ } \hfill \uncover<4->{MapReduce is distributed $\underbrace{\mbox{\textcolor{darkorange}{\bf SELECT}-\textcolor{darkorange}{\bf WHERE}}}_{\mbox{``map''}}\mbox{-}\underbrace{\mbox{\textcolor{darkorange}{\bf GROUP BY}}}_{\mbox{``reduce''}}$.} \hfill \mbox{ }

\vspace{0.7 cm}
\uncover<5->{\textcolor{gray}{2004: published by Dean and Ghemawat}}

\uncover<5->{\textcolor{gray}{2006: implemented in open-source as Hadoop.}}
\end{frame}
