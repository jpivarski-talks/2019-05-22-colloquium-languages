...
\vspace{0.75 cm}
\begin{center}
\uncover<3->{\textcolor{darkblue}{\LARGE Recently renamed ``map-reduce.''}}
\end{center}
\end{columns}
\end{frame}
...
\vspace{0.7 cm}
\uncover<3->{2003: task distribution automated by the in-house MapReduce framework.}
...
\vspace{0.7 cm}
\uncover<5->{\textcolor{gray}{2004: published by Jeffrey Dean and Sanjay Ghemawat.}}

\uncover<5->{\textcolor{gray}{2006: reimplemented as open-source software, named Hadoop.}}
\end{frame}
...
\begin{columns}
\column{0.65\linewidth}
1945: John von Neumann learned of their work and repurposed it for Monte Carlo simulations (H-bomb).
...
\begin{frame}{ENIAC was programmed exclusively by six women}
