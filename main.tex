...
\vspace{0.7 cm}
\uncover<2->{In fact, FORTRAN (pre-Fortran 90) wasn't even a good fit to {\it data analysis} problems. It lacked jagged tables just as SQL does.}
...
\vspace{0.25 cm}
\uncover<3->{What we see here are individuals choosing for themselves, for their own work.}
\end{frame}
