...
\vspace{0.5 cm}
\begin{center}
Because, you know, the water's moved.
\end{center}
\end{frame}
...
\begin{frame}{Science also has layers of abstraction}
\large
\vspace{0.75 cm}
\includegraphics[width=\linewidth]{atom-proton-quark.png}

\vspace{1 cm}
\textcolor{gray}{although these are approximate, taking advantage of a separation of scales.}
\end{frame}

\begin{frame}{(not to scale)}
\vspace{0.2 cm}
