...
Python is slower than Numba because it has more hurdles in the way: dynamic typing, pointer-chasing, garbage collection, string lookups\ldots
\end{uncoverenv}
\end{frame}
...
\vspace{1 cm}
But an implementation can be hampered by \\ all the flexibility a language promises.
\end{center}
\end{frame}
