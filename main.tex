...
\item Shares {\it none} of the original code, written in a {\it completely} different style.
\end{itemize}
...
\vspace{1.25 cm}
\begin{center}
{\LARGE That's why it was called ``coding.''}

\vspace{0.25 cm}
Programmers had to manually look up instruction codes.

\vspace{1.5 cm}
\uncover<2->{\textcolor{darkblue}{Von Neumann on Assembly Language:} ``It's a waste of a valuable scientific computing instrument to use it for clerical work!''}
\end{center}
\end{frame}
