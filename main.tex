...
%% \LARGE
%% \vspace{1.25 cm}
%% So physicists needed general-purpose (stored program) computers to solve a complex problem---Monte Carlo.

%% \vspace{1 cm}
%% Data analysis requires less generality, but if you have a general-purpose hammer\ldots
%% \end{frame}
...
%% \vspace{0.5 cm}
%% \begin{center}
%% How many here today have used MINUIT \\ (general-purpose fitting) to fit a straight line?
%% \end{center}
%% \end{frame}
